...
schema_view = get_schema_view(
    openapi.Info(
        title="My Blog Application API",
        default_version='v1',
        description="This API allows users to register, login, and manage blogs.",
        terms_of_service="https://www.example.com/terms",
        contact=openapi.Contact(email="support@myblogapp.com"),
...
urlpatterns = [
    ...
    path('api/', include('post_management.urls')), 
